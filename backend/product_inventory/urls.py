...
from .views import get_categories, get_products, create_category, create_product, get_products_by_category, get_product_by_id, update_product, delete_product, save_pending_order, get_pending_orders, delete_pending_order, save_completed_orders, get_completed_orders, get_total_sales, get_total_products_quantity, get_low_stock_items, get_expiring_products, get_pending_orders_number, get_completed_orders_number
